...
public class TestPetEntity extends TamableAnimal {
    ...
    private static final net.minecraft.network.syncher.EntityDataAccessor<Integer> ANIM_STATE =
            net.minecraft.network.syncher.SynchedEntityData.defineId(TestPetEntity.class, net.minecraft.network.syncher.EntityDataSerializers.INT);
    ...
    public TestPetEntity(EntityType<? extends TamableAnimal> type, Level level) {
        super(type, level);
    ...
    public boolean isPlayingDead() { return getCurrentAnimation() == PetAnimation.PLAY_DEAD; }
    ...
    public InteractionResult mobInteract(Player player, InteractionHand hand) {
        ...
        if (player.isSecondaryUseActive()) {
            player.openMenu(new SimpleMenuProvider(
                    (id, playerInv, pl) -> new com.kingodogo.buildscape.network.PetMenu(id, playerInv, this.inventory, this),
    ...
    public static class PetCooldownWanderGoal extends Goal {
        ...
        private final TestPetEntity pet;
        private final double speedModifier;
        private int nextMoveTimer = 0;

        public PetCooldownWanderGoal(TestPetEntity pet, double speedModifier) {
            this.pet = pet;
    ...
    public static class PetBoredGoal extends Goal {
        ...
        public PetBoredGoal(TestPetEntity pet) {
            this.pet = pet;
    ...
    public static class PetAnnoyOwnerGoal extends Goal {
        ...
        public PetAnnoyOwnerGoal(TestPetEntity pet) {
            this.pet = pet;
    ...
    public static class PetExamineGoal extends Goal {
        ...
        public PetExamineGoal(TestPetEntity pet) {
            this.pet = pet;
            this.setFlags(java.util.EnumSet.of(Goal.Flag.MOVE, Goal.Flag.LOOK));
        }
    ...
    public static class PetRetaliateGoal extends Goal {
        ...
        public PetRetaliateGoal(TestPetEntity pet, double speedModifier, boolean followingTargetEvenIfNotSeen) {
            this.pet = pet;
            this.setFlags(java.util.EnumSet.of(Goal.Flag.MOVE, Goal.Flag.LOOK));
        }
