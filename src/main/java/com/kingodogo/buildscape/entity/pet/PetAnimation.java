...
public enum PetAnimation {
    IDLE {
        ...
        public void applyMath(AnimationTarget t, float age, float swing, float amount, boolean ground) {
            ...
            if (idleScale > 0.5F) {
                ...
                t.rightArmZ += wave * 0.1F;
                t.leftArmZ -= wave * 0.1F;
            }
        }
    },
    WALK {
    ...
    SLEEPING {
        ...
        public void applyMath(AnimationTarget t, float age, float swing, float amount, boolean ground) {
            ...
            t.rightArmX = -(float) Math.PI / 2F;
            t.leftArmX = -(float) Math.PI / 2F;
            t.rightLegX = -(float) Math.PI / 2F;
            t.leftLegX = -(float) Math.PI / 2F;
    ...
    JUMPING {
        ...
        public void applyMath(AnimationTarget t, float age, float swing, float amount, boolean ground) {
            ...
            t.rightArmX = -hop * 0.5F;
            t.leftArmX = -hop * 0.5F;
            t.rightLegX = hop * 0.2F;
            t.leftLegX = hop * 0.2F;
        }
    },
    HEAD_BANG {
    ...
    CRAWL {
        ...
        public void applyMath(AnimationTarget t, float age, float swing, float amount, boolean ground) {
            ...
            t.rightArmY = Mth.sin(age * 0.2F) * 0.8F;
            t.leftArmY = -Mth.sin(age * 0.2F) * 0.8F;
    ...
    WAVE {
        ...
        public void applyMath(AnimationTarget t, float age, float swing, float amount, boolean ground) {
            t.rightArmZ = 2.0F;
            t.rightArmX = Mth.sin(age * 0.4F) * 0.5F;
        }
    },
    PROJECT_HOLOGRAM {
        @Override
