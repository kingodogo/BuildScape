...
public class ModBlockEntities {
    ...
    public static final DeferredRegister<BlockEntityType<?>> BLOCK_ENTITIES =
            DeferredRegister.create(ForgeRegistries.BLOCK_ENTITIES, BuildScape.MODID);

    public static final RegistryObject<
            BlockEntityType<PillarBlockEntity>
            > PILLAR_BLOCK_ENTITY = BLOCK_ENTITIES.register("pillar_block_entity", () ->
    ...
    public static final RegistryObject<
            BlockEntityType<DecoratedPotBlockEntity>
            > DECORATED_POT_BLOCK_ENTITY = BLOCK_ENTITIES.register(
    ...
    public static final RegistryObject<
            BlockEntityType<IcicleCauldronBlockEntity>
            > ICICLE_CAULDRON_BLOCK_ENTITY = BLOCK_ENTITIES.register(
            "icicle_cauldron_block_entity",
            () ->
                    BlockEntityType.Builder.of(
                            IcicleCauldronBlockEntity::new,
                            ModBlocks.ICICLE_CAULDRON.get()
                    ).build(null)
    );

    public static final RegistryObject<
            BlockEntityType<FestiveStockingBlockEntity>
            > FESTIVE_STOCKING_BLOCK_ENTITY = BLOCK_ENTITIES.register(
    ...
    public static final RegistryObject<
            BlockEntityType<MangroveSignBlockEntity>
            > MANGROVE_SIGN_BLOCK_ENTITY = BLOCK_ENTITIES.register(
    ...
    public static final RegistryObject<
            BlockEntityType<BambooSignBlockEntity>
            > BAMBOO_SIGN_BLOCK_ENTITY = BLOCK_ENTITIES.register(
    ...
    public static final RegistryObject<
            BlockEntityType<GlowLightsBlockEntity>
            > GLOW_LIGHTS_BLOCK_ENTITY = BLOCK_ENTITIES.register(
