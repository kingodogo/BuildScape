package com.kingodogo.buildscape.data.legacy;
...
// import com.kingodogo.buildscape.block.ModVerticalSlabs; // DELETED
// import com.kingodogo.buildscape.block.ModVerticalStairs; // DELETED
...
public class DynamicDataPack implements PackResources {
    ...
    private void generateServerData(Map<Block, Block> slabMap, Map<Block, Block> stairMap) {
        ...
        slabMap.forEach((parentSlab, verticalSlab) -> {
            ...
            // Recipes - DISABLED: Now handled by VerticalResourcePack
