...
public class BuildScape {
                    ...
                    for (String pillarId : manager.getAllPillarIds()) {
                        try {
                            com.kingodogo.buildscape.config.PillarIdManager.PillarData data =
                                    manager.getPillarData(pillarId);
                            if (
                                    data == null || !data.dimension.equals(dimensionKey)
                            ) continue;
                            ...
                            if (
                                ...
                                if (
                                        pillarBE.getPillarId() == null ||
                                                !pillarBE.getPillarId().equals(data.id)
                                ) {
    ...
    public void onLeftClickBlock(
        ...
        if (
                block instanceof com.kingodogo.buildscape.block.PetalBlock ||
    ...
    public void onRightClickBlock(
        ...
        if (
                state.getBlock() == ModBlocks.MANGROVE_LEAVES.get() &&
        ...
        if (
                state.getBlock() == ModBlocks.BAMBOO_BLOCK.get() &&
        ...
        if (
            ...
            if (
                    net.minecraft.world.item.alchemy.PotionUtils.getPotion(heldItem) ==
                                    ...
                                    if (dyeColors != null && !dyeColors.isEmpty()) {
                                        ...
                                        try {
                                            if (
                                                ...
                                                int color = Integer.parseInt(colorCode.substring(1), 16);
                            ...
                            if (item instanceof net.minecraft.world.item.BlockItem) {
                                ...
                                if (
                                    ...
                                    color = vanillaItemColors.getColor(
                                        ...
                                        block == ModBlocks.JUNGLE_LEAF_HEDGE.get() ||
                                                block == ModBlocks.JUNGLE_LEAF_LAYERS.get()
                                ) {
                                    color = vanillaItemColors.getColor(
                                            new net.minecraft.world.item.ItemStack(
                                        ...
                                        block == ModBlocks.ACACIA_LEAF_HEDGE.get() ||
                                                block == ModBlocks.ACACIA_LEAF_LAYERS.get()
                                ) {
                                    color = vanillaItemColors.getColor(
                                            new net.minecraft.world.item.ItemStack(
                                        ...
                                        block == ModBlocks.DARK_OAK_LEAF_HEDGE.get() ||
                                    ...
                                    color = vanillaItemColors.getColor(
                                        ...
                                        block == ModBlocks.SPRUCE_LEAF_HEDGE.get() ||
                                                block == ModBlocks.SPRUCE_LEAF_LAYERS.get()
                                ) {
                                    color = 0x619961;
                                } else if (
                                        block == ModBlocks.BIRCH_LEAF_HEDGE.get() ||
                                                block == ModBlocks.BIRCH_LEAF_LAYERS.get()
                                ) {
                                    color = 0x80a755;
                                } else if (
                                        block == ModBlocks.MANGROVE_LEAVES.get() ||
                                                block == ModBlocks.MANGROVE_LEAF_LAYERS.get() ||
                                                block == ModBlocks.MANGROVE_LEAF_HEDGE.get()
                                ) {
                                    color = 0x92c648;
                                }
